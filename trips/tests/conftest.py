        ...
        'logbook_days': [
            {
                ...
                'events': [
                    {'status': 'DRIVING', 'start_hour': 0.0, 'end_hour': 11.0, 'label': 'Driving'},
                    {'status': 'ON_DUTY_ND', 'start_hour': 11.0, 'end_hour': 12.0, 'label': 'On-duty'},
                    {'status': 'OFF_DUTY', 'start_hour': 12.0, 'end_hour': 24.0, 'label': 'Off-duty'},
                ]
            }
        ],
